...
export default function Example() {
  return (
    <div className="transition-colors duration-300 bg-white dark:bg-gray-900" id='about'>
      <div className="py-24 mx-auto max-w-7xl sm:px-6 sm:py-32 lg:px-8">
        <div className="relative px-4 pt-8 overflow-hidden bg-gray-900 shadow-2xl isolate sm:px-6 sm:pt-16 dark:bg-gray-800 sm:rounded-3xl md:px-16 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0" id="glow">
          <svg
